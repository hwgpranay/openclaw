...
import { SessionCreatorIdentitySchema, type SessionCreatorIdentity } from "./sessions.js";
...
export const SessionSharingIdentitySchema = SessionCreatorIdentitySchema;
...
export type SessionSharingIdentity = SessionCreatorIdentity;
